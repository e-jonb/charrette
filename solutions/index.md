...
| Date | Solution | Workspace | Format | Stack | Key Decisions | Status |
|---|---|---|---|---|---|---|

<!-- New entries go at the top of the table. Format:
| YYYY-MM-DD | Solution Name | personal / professional / business | Full App / Script / API / Personal Workspace | Stack Summary | Brief: key ADRs and notable choices | Active / Maintenance / Retired |
-->
